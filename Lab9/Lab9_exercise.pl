...
pr10:- Positions = [0,1,2,3,4,5,6], Itog_slovo = [_,_,_,_,_,_,_], P = [1,2,3,4], 
	...
	del_sub(Positions,L1_positions,P1),
	in_list_exlude(P,NumEl2,_), sochet(L2_positions,NumEl2,P1), 
	del_sub(P1,L2_positions,P2),
	in_list_exlude(P,NumEl3,_), sochet(L3_positions,NumEl3,P2), 
	del_sub(P2,L3_positions,P3),
	in_list_exlude(P,NumEl4,_), sochet(L4_positions,NumEl4,P3), 
